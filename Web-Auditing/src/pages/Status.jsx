  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Website Status Overview</h1>
              ...
              {websiteList.length > 0 ? (
                <div className="divide-y divide-gray-200">
                  {websiteList.map((website) => (
                    <div key={website.id} className="px-6 py-4 hover:bg-gray-50 transition-colors">
                        ...
                        <div className="flex items-center gap-6 ml-4">
                          <div className="hidden md:flex gap-3">
                            <div className="text-center">
                              ...
                              <StatusBadge status={website.securityCheck} showIcon={false} />
                            </div>
                            <div className="text-center">
                              <div className="text-xs text-gray-500 mb-1">Function</div>
                              <StatusBadge status={website.functionalityTest} showIcon={false} />
                            </div>
                            <div className="text-center">
                              <div className="text-xs text-gray-500 mb-1">SEO</div>
                              <StatusBadge status={website.seo} showIcon={false} />
                            </div>
                          </div>
                          <Link
